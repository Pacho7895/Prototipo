      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="shadow-xl rounded-2xl">
          <CardContent className="flex flex-col items-center p-6">
            ...
            <p className="text-center text-gray-700">
              Captura energía solar incluso en días parcialmente nublados. Ideal
              para el clima húmedo del Chocó.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-xl rounded-2xl">
          <CardContent className="flex flex-col items-center p-6">
            ...
            <p className="text-center text-gray-700">
              Batería de larga duración que permite almacenar energía para usar
        ...
        <Card className="shadow-xl rounded-2xl">
          <CardContent className="flex flex-col items-center p-6">
            ...
            <p className="text-center text-gray-700">
              Iluminación segura y eficiente para el estudio nocturno, cocinar y
              desplazarse.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-xl rounded-2xl">
          <CardContent className="flex flex-col items-center p-6">
            ...
            <p className="text-center text-gray-700">
              Permite cargar celulares y escuchar noticias o programas
        ...
        <Card className="shadow-xl rounded-2xl">
          <CardContent className="flex flex-col items-center p-6">
            ...
            <p className="text-center text-gray-700">
              Manual visual en lengua local y formación básica para
              mantenimiento del kit por jóvenes de la comunidad.
            </p>
          </CardContent>
        </Card>
      </div>
